        ...
        private void updatemidiCtrls(int[] ccList)
        {
            ...
            if (ccList[1] != 0)
            {
                ...
                if ((ccList[1] & 0x20) == 0x20)
                    pbRewind.Image = synth.GetChannelHoldPedalStatus(1) ? Properties.Resources.holdon : Properties.Resources.holdoff;
            ...
            if (ccList[14] != 0)
            {
                ...
                //pbRewind0.Image = infos[0].mute ? Properties.Resources.mute : Properties.Resources.unmute;
            }
            if (ccList[15] != 0)
            {
                ...
                if ((ccList[15] & 0x20) == 0x20)
                    pbRewind1.Image = synth.GetChannelHoldPedalStatus(15) ? Properties.Resources.holdon : Properties.Resources.holdoff;
                //pbRewind2.Image = infos[0].mute ? Properties.Resources.mute : Properties.Resources.unmute;
            }
        }
