    ...
    public partial class PlayControls : Form
    {
        ...
        public void updateButtons(SynthWaveProvider.PlayerState pstate)
        {
            if (pstate != SynthWaveProvider.PlayerState.Stopped)
                pbPlay.Image = Properties.Resources.stop;
            else
        ...
        {
            pbFastForward.Image = Properties.Resources.forward_d;
        }
        private void pictureBox1_MouseUp(object sender, MouseEventArgs e)
        {
            pbFastForward.Image = Properties.Resources.forward;
        }
        ...
        {
            pbPause.Image = Properties.Resources.pause_d;
        }
        ...
        private void pictureBox2_MouseDown(object sender, MouseEventArgs e)
        {
            if (((MainForm)this.ParentForm).GetPlayerState() == SynthWaveProvider.PlayerState.Playing)
                pbPlay.Image = Properties.Resources.stop_d;
            else
                pbPlay.Image = Properties.Resources.play_d;
        }
        ...
        private void pbRewind_MouseDown(object sender, MouseEventArgs e)
        {
            pbRewind.Image = Properties.Resources.backward_d;
        }
        private void pbRewind_MouseUp(object sender, MouseEventArgs e)
        {
            pbRewind.Image = Properties.Resources.backward;
        }
